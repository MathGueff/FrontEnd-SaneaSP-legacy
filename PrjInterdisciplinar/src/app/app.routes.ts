...
import { MainComentarioComponent } from './Comentario/main-comentario/main-comentario.component';
...
export const routes: Routes = [
  ...
  {path: 'reclamacao/comentarios/:id', component:MainComentarioComponent},
